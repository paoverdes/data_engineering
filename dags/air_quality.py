...
def new_db_connection():
    ...
    route = 'postgresql://' + Variable.get("db_user") + ':' + Variable.get("secret_db_password") + '@' + host + ':' + str(port) + '/' + database
...
def insert_information(data_all_sites):
    ...
    for i in range(len(df)):
        ...
        conn.execute("insert into airquality_data_temp (region, aqi, co, no2, o3, status, date) "
